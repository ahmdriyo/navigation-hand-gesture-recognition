...
- **PWA Ready**: Service worker dan manifest included
- **Accessibility**: WCAG 2.1 AA compliant
- **Screen Reader**: Full support dengan semantic HTML
...
### ✅ Completed Features
- [x] Basic gesture recognition (Victory, Open Palm, Pointing Up, Thumbs Down)
...
### 🚧 In Progress
- [ ] Enhanced gesture accuracy with confidence scoring
...
- [ ] Gesture shortcuts for complex actions
...
- Dokumentasikan code dengan JSDoc
- Maintain accessibility standards

### Bug Reports
- Gunakan GitHub Issues untuk bug reports
- Berikan informasi detail tentang bug
...
- Cek permission camera di browser settings
...
- Pastikan tangan terlihat jelas di camera
- Coba gesture dengan gerakan yang lebih distinct
