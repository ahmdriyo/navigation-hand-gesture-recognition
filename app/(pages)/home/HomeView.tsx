      ...
      <section className="pt-16 min-h-screen flex items-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-10">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-3 sm:px-4 py-2 rounded-full bg-blue-100 text-blue-700 text-xs sm:text-sm font-medium mb-4 sm:mb-6 animate-bounce">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-xs sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto leading-relaxed px-4">
              Experience the future of web navigation with our revolutionary
              gesture recognition system. Control your browsing experience with
              simple hand movements - no touch required!
            </p>

            {/* Gesture Demo Icons */}
            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 px-4">
              <div className="text-center group">
                <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-2 group-hover:scale-125 transition-transform duration-300">
                  ✋
                </div>
                <p className="text-xs sm:text-sm text-gray-500">Open Palm</p>
              </div>
              <div className="text-center group">
                <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-2 group-hover:scale-125 transition-transform duration-300">
                  ✌️
                </div>
                <p className="text-xs sm:text-sm text-gray-500">Victory</p>
              </div>
              <div className="text-center group">
                <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-2 group-hover:scale-125 transition-transform duration-300">
                  ☝️
                </div>
                <p className="text-xs sm:text-sm text-gray-500">Pointing Up</p>
              </div>
              <div className="text-center group">
                <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-2 group-hover:scale-125 transition-transform duration-300">
                  👍
                </div>
                <p className="text-xs sm:text-sm text-gray-500">Thumbs Down</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <a
                href="/demo"
                className="group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
              >
              ...
              <a
                href="/documentation"
                className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose Gesture Navigation?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Revolutionary technology that transforms how you interact with web
              applications
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl hover:from-blue-100 hover:to-blue-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Menggunakan MediaPipe AI untuk mengenali gesture dengan akurasi
            ...
            <div className="group p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Deteksi gesture secara real-time dengan response time kurang
                dari 100ms untuk pengalaman yang smooth.
              </p>
            </div>
            ...
            <div className="group p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl hover:from-green-100 hover:to-green-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Semua processing dilakukan secara lokal di browser, tidak ada
            ...
            <div className="group p-8 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl hover:from-orange-100 hover:to-orange-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Berjalan sempurna di semua browser modern dan perangkat, tanpa
            ...
            <div className="group p-8 bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl hover:from-pink-100 hover:to-pink-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Mudah diintegrasikan ke dalam proyek Next.js dengan komponen
            ...
            <div className="group p-8 bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl hover:from-teal-100 hover:to-teal-200 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">
                Memberikan alternatif navigasi untuk pengguna dengan
                keterbatasan fisik atau preferensi khusus.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Teknologi gesture navigation bekerja dalam 4 langkah sederhana
              namun canggih
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Mengakses kamera perangkat untuk menangkap gerakan tangan
                real-time
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                MediaPipe AI menganalisis dan mengenali gesture tangan dengan
                akurasi tinggi
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Gesture diubah menjadi perintah navigasi yang spesifik untuk
                setiap halaman
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Sistem mengeksekusi navigasi ke halaman tujuan dengan smooth
                transition
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 text-gray-700 text-sm font-medium">
              💡{" "}
              <span className="ml-2">
                Tip: Hold gesture for 1 second to trigger navigation
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
              Join the revolution of touchless navigation and create web
              applications that respond to your every gesture. The future of
              interaction is here, and it&apos;s in your hands.
            </p>
